...
const STAT_LABELS = [
  ...
  ['kills_ghost', 'Ghosts'], ['kills_grunt', 'Grunts'], ['kills_demon', 'Demons'], ['generators', 'Generators destroyed'],
...
async function main() {
  ...
  const render = (t) => {
    ...
    const rows = lb[t] || [];
    const head = { scores: ['#', 'Hero', 'Class', 'Score', 'Level', 'Kills', 'When'], depth: ['#', 'Hero', 'Deepest level'], kills: ['#', 'Hero', 'Kills'], achievements: ['#', 'Hero', 'Achievements'] }[t];
